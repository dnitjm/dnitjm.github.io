...
(function ($) {
	...
	$.fn.editableSelect = function (options) {
		...
		var select = this.clone(), input = $('<input type="text">'), span = $('<span class="btn_dd"></span'), list = $('<ul class="es-list">');
		...
		var EditableSelect = {
			...
			initializeEvents: function () {
				var es = this;
				input.bind('input keyup', function (event) {
